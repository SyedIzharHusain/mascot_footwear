class SEModel {
  ...
  SEModel.fromJson(Map<String, dynamic> json) {
    id = json['id'];
...
class Display {
  ...
  Map<String, dynamic> toJson() {
    ...
    if (options != null) {
      data['options'] = options!.map((v) => v).toList();
    }
...
class VisibilityCondition {
  ...
  Map<String, dynamic> toJson() {
    ...
    if (orConditions != null) {
      data['orConditions'] = orConditions!.map((v) => v).toList();
    }
    return data;
  }
}
...
class Conditions {
  ...
  Conditions({this.fieldId, this.compareWith});
...
class Options {
  ...
  Options({this.text, this.iconUrl, this.value, this.type});
